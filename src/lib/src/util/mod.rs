...
pub fn map_gltf_format_to_vulkano(format: gltf::image::Format) -> vulkano::format::Format {
    match format {
        gltf::image::Format::R8 => vulkano::format::Format::R8_SRGB,
        gltf::image::Format::R8G8 => vulkano::format::Format::R8G8_SRGB,
        gltf::image::Format::R8G8B8 => vulkano::format::Format::R8G8B8_SRGB,
        gltf::image::Format::R8G8B8A8 => vulkano::format::Format::R8G8B8A8_SRGB,
